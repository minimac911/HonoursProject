...
using CatalogCustomization.Helper;
using CatalogCustomization.Infastrucutre.Tenancy;
using CatalogCustomization.Services;

namespace CatalogCustomization.Infastrucutre.Startup
{
        ...
        public static IServiceCollection AddSecurity(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services
                ...
                .AddJwtBearer(o =>
                {
                    ...
                    o.Audience = "tenant_customization";
            ...
            services
                .AddAuthorization(options =>
                {
                    options.AddPolicy("ApiScope", policy =>
                    {
                        ...
                        policy.RequireClaim("scope", "tenant_customization");
                    });
                });
